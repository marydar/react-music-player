  ...
  return(
    <div className="bg-gray-950 flex w-full h-[9%] justify-between">
      ...
      <div className="flex  justify-center items-center">
        ...
        {/* loop */}
        <div className="flex mr-2 ml-2">
          <svg fill="currentColor" className="w-6" viewBox="0 0 16 16" class="size-6">
